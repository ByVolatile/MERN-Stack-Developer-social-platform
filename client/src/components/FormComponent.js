...
const FormComponent = () => {
  ...
  return (
    <>
      <Container style={{ marginTop: "18vh",backgroundColor:"white",width:"40vw",paddingBottom:"5vh",borderRadius:"10px" }}>

        <div  style={{ width:"40vw",margin:"auto",paddingTop:"10px" }}>KSG</div>
      {userDataError && <div style={{color:"red",marginTop:"10px"}}>İşlem Başarısız Lütfen Tekrar deneyin</div>}
      {userDataSucces && <div style={{color:"green"}}>İşlem Başarılı Anasayfaya yönlendiriliyorsunuz </div>}
